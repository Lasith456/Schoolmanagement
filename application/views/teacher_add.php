                ...
                <!-- Main Content -->
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- Page Heading -->
                            <h1 class="h3 mb-2 text-gray-800">Teacher Add</h1>
                            <p class="mb-4">Please add new teacher's details.</p>
                            <div class="container">
                                <form class="form-group" id="addTeacher">
                                    ...
                                    <button class="btn btn-primary btn-user btn-block" onclick="addTeacher()">
                                        Add Teacher</button>
</form>
                            </div>
                        </div>
